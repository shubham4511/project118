...
Element_of_array = array_1[random_nomber];
...
function gotResults(error,Results){
    ...
    ducument.getElementById("confidence").innerHTML="Confidence:"+Math.round(results[0].confidence*100)+'%';
}